#!/usr/bin/env python3
"""
Fix the duplicate September 18th entries in the daily_workouts section
"""

import json
import sys

def fix_sept18_daily_workouts():
    # Load the data
    with open('exercise_data/workout_history_data_categorized.json', 'r') as f:
        data = json.load(f)
    
    # Find the duplicate entries for 2024-09-18 in daily_workouts
    ...
    if '2024-09-18' in daily_workouts:
        ...
        if len(sept18_workouts) > 1:
            print(f"Found {len(sept18_workouts)} entries for 2024-09-18 in daily_workouts")
            ...
            print("Fixed September 18th duplicate entries in daily_workouts")
        else:
            print("No duplicate entries found for 2024-09-18 in daily_workouts")
    else:
        print("No entries found for 2024-09-18 in daily_workouts")

if __name__ == '__main__':
    fix_sept18_daily_workouts()
